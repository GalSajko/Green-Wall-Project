...
if __name__ == "__main__":
    ...
    spiderStartPose = [0.44, 0.345, 0.035, 0, 0, 0]
    spiderGoalPose = [0.44, 1.0, 0.15, 0, 0, 0]
    ...
    poses, pins = pathPlanner.calculateWalkingMovesFF(spiderStartPose, spiderGoalPose, 0.05)
    print(pins)
    print(poses)
