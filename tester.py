...
if __name__ == "__main__":
    ...
    spiderPose = motors.readPlatformPose([0, 1, 2, 3, 4], [pins[21], pins[8], pins[6], pins[30], pins[32]])
    ...
    spiderPose = motors.readPlatformPose([1, 2, 3, 4], [pins[8], pins[6], pins[30], pins[32]])
